...
func NewTerminalApprover() (*TerminalApprover, error) {
	...
	session, err := session.NewSession(in, out)
	if err != nil {
		_ = in.Close()
		_ = out.Close()
		return nil, err
...
func (a *AutoApprover) Approve(_ context.Context, _ policy.ToolCall, _ policy.PolicyDecision) (bool, error) {
	return true, nil
}

func (a *AutoDenier) Approve(_ context.Context, _ policy.ToolCall, _ policy.PolicyDecision) (bool, error) {
	return false, nil
}

func (t *TerminalApprover) Approve(ctx context.Context, call policy.ToolCall, decision policy.PolicyDecision) (bool, error) {
